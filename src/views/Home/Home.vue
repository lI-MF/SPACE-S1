      ...
      <div class="area-functional">
        ...
        <comp-function>
          <template v-slot:write-btn>
            <el-button type="primary" class="function_btn" circle
              ><i class="iconfont icon-zengjia"></i
            ></el-button>
            <el-button type="warning" class="function_btn" circle
              ><i class="iconfont icon-xiugai"></i
            ></el-button>
            <el-button type="danger" class="function_btn" circle
...
export default {
  ...
  data() {
    return {
      ...
      //   // },
      //   {
      //     content: "02卡号的卡就是的卡上的",
      //     timestamp: "2018-04-13",
      //   },
      //   {
      //     content: "03卡号的卡就是的卡上的",
      //     timestamp: "2018-04-11",
      //   },
      //   {
      //     content: "04卡号的卡就是的卡上的",
      //     timestamp: "2018-04-11",
      //   },
      // ],
    }
